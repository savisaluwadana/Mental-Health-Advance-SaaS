  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Today's Sessions", value: todaySessions.length, icon: '📅', href: '/dashboard/practitioner/schedule' },
          { label: 'Sessions This Week', value: weekSessions, icon: '📊', href: '/dashboard/practitioner/schedule' },
          { label: 'Total Clients', value: totalClients, icon: '👥', href: '/dashboard/practitioner/clients' },
          { label: 'Flagged Messages', value: flaggedMessages.length, icon: '🚨', href: '/dashboard/practitioner/messages' },
        ].map((stat) => (
          ...
          <div className="space-y-3">
            {todaySessions.map((s: any) => (
              <div key={s._id.toString()} className="card p-4 flex items-center gap-4">
                ...
                <div className="h-10 w-0.5 bg-brand-200 dark:bg-brand-800 rounded-full" />
