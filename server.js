/*
  Custom Node server is temporarily disabled for Netlify deployment.
  Use Next.js default runtime via:
  - npm run dev   -> next dev
  - npm run start -> next start

  Previous server implementation kept below for future use:
